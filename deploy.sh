...
# Note: Verified name from 'docker images' is healthcoach-healthcoach-bot
if ssh -o StrictHostKeyChecking=no cameron@$TEST_IP "trivy image --severity HIGH,CRITICAL healthcoach-healthcoach-bot"; then
    echo ""
